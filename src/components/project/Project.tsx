...
const Project = () => {
  ...
  const next = () => {
    //@ts-ignore
    sliderContainerRef.current.scrollLeft += 657
    //@ts-ignore
    sliderTextRef.current.scrollLeft += 395
  }
  const prev = () => {
    //@ts-ignore
    sliderContainerRef.current.scrollLeft -= 657
  ...
  return (
    <div className="h-[83vh] flex justify-between pr-[6rem] pl-[6rem]">
      ...
      <div className="pt-[6rem] flex">
        <div>
          ...
          <div className="w-[100%] flex justify-center gap-[20rem] mt-[2rem]">
            <a
